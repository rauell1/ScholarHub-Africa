    ...
    <>
      ...
      <section className="mx-auto max-w-7xl px-4 py-10 sm:px-6">
        <div className="grid gap-8 lg:grid-cols-2">
          ...
          <div className="card">
            <h2 className="text-lg font-bold text-foreground">Find us</h2>
            ...
            <h3 className="mt-5 text-sm font-bold uppercase tracking-wide text-foreground">Directions</h3>
            ...
            <p className="mt-3 text-xs text-muted-foreground">Hours: {site.hours}. Drop-ins welcome.</p>
          </div>
        </div>
      </section>
    </>
