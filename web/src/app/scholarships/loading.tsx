    ...
    <>
      ...
      <section className="bg-navy py-10 text-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          ...
          <div className="mt-4 h-8 w-64 animate-pulse rounded bg-white/20 sm:w-96" />
      ...
      <section className="mx-auto max-w-7xl px-4 py-8 sm:px-6">
        <div className="grid gap-6 lg:grid-cols-4">
          ...
          <aside className="lg:col-span-1">
            <div className="space-y-5 rounded-2xl bg-white p-4 ring-1 ring-navy/5 hidden md:block">
              ...
              {[...Array(5)].map((_, i) => (
                <div key={i} className="mt-4 space-y-2">
                  ...
                  <div className="h-6 w-full animate-pulse rounded bg-navy/5" />
                  <div className="h-6 w-full animate-pulse rounded bg-navy/5" />
                </div>
              ))}
            </div>
          ...
          <div className="lg:col-span-3">
            <div className="mb-4 flex items-center justify-between gap-3">
              ...
              <div className="h-10 w-40 animate-pulse rounded-lg bg-navy/5" />
            </div>
            ...
            <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
              {[...Array(6)].map((_, i) => (
                <div
                  key={i}
                  className="flex h-64 flex-col gap-3 rounded-xl border border-navy/5 bg-white/50 p-5 shadow-sm"
                >
                  <div className="flex justify-between">
                    <div className="h-6 w-10 animate-pulse rounded bg-navy/10" />
                    <div className="h-6 w-16 animate-pulse rounded bg-navy/10" />
                  </div>
